...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://pizzahut-fbb16.firebaseio.com/"),
    refCart = new Firebase("https://pizzahut-fbb16.firebaseio.com/cart"),
    refUser = new Firebase("https://pizzahut-fbb16.firebaseio.com/users"),
    refCategory = new Firebase("https://pizzahut-fbb16.firebaseio.com/category"),
    refOrder = new Firebase("https://pizzahut-fbb16.firebaseio.com/orders"),
    refFeatured = new Firebase("https://pizzahut-fbb16.firebaseio.com/featured"),
    refMenu = new Firebase("https://pizzahut-fbb16.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
